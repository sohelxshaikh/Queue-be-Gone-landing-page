export const features = [
  {
    ...
    title: "Work efficiently, not harder",
    text: "Our University Print Hub simplifies everything. Automated workflows and smart features eliminate tedious tasks, allowing you to focus on what matters. It’s like having extra support, minus the stress.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Watch the System in Action",
    },
  },
  {
    id: "1",
    ...
    text: "With our University Print Hub, data security comes first. Advanced encryption and privacy controls keep your information safe and secure, letting you focus with confidence.",
    button: {
